...
class Prophet(QMainWindow):
    ...
    def on_start(self):
        ...
        if mode == AppMode.SINGLE:
            ...
            """
            self.list_tick = ['ticks_20251208.xlsx', 'ticks_20251209.xlsx', 'ticks_20251210.xlsx',
                              'ticks_20251211.xlsx', 'ticks_20251212.xlsx', 'ticks_20251215.xlsx',
                              'ticks_20251216.xlsx', 'ticks_20251217.xlsx', 'ticks_20251218.xlsx',
                              'ticks_20251219.xlsx']
